...
1. **MyMemex must be installed and running**
   ```bash
   # Start MCP server
   mymemex mcp serve
   ```
...
This skill uses these MyMemex MCP tools:
...
Add MyMemex MCP server to your OpenClaw config:
...
### "MyMemex MCP server not responding"
