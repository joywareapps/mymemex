#!/usr/bin/env python3
"""
Test MCP connection to MyMemex by verifying tool registration.
...
def main():
    print("Testing MyMemex MCP server registration...")
    print()

    try:
        from mymemex.config import load_config
        from mymemex.mcp import create_mcp_server
    except ImportError:
        print("[FAIL] MyMemex not installed")
        print("  Install with: pip install mymemex")
        return 1
