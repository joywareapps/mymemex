#!/usr/bin/env python3
"""
Check if MyMemex server is running and healthy.
...
def main():
    parser = argparse.ArgumentParser(description="Check MyMemex server status")
    parser.add_argument("--port", type=int, default=8000, help="REST API port")
    args = parser.parse_args()

    print("Checking MyMemex server status...")
    print()
    ...
    print()
    print("[OK] MyMemex server is healthy!")
    return 0
